    ...
    >
      <div className="space-y-4">
        ...
        <div className="items-center  flex flex-col space-y-4">
          ...
          <Link to="/guru">
            <button className="relative group bg-gradient-to-b from-green-500 to-green-600 hover:from-green-600 hover:to-green-700 text-white font-bold py-2 px-9 rounded-full transition-transform transform hover:scale-105 shadow-2xl">
              <span className="absolute inset-0 bg-opacity-50 bg-white rounded-full transform scale-110 opacity-0 group-hover:opacity-100 transition-opacity"></span>
              Guru
            </button>
          </Link>
