  ...
  return (
    <div className="border pt-2 pb-2 pr-3 pl-3 rounded-2xl bg-greendark mx-auto flex justify-between items-center px-4 space-x-2">
      ...
      <button
        ...
        onClick={() => navigate("/riwayat", { state: { userEmail: "email_siswa_di_sini" } })}
      >
        <svg width="22" height="22" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path
            ...
            fillRule="evenodd"
            clipRule="evenodd"
            style={{ color: location.pathname === "/riwayat" ? "white" : "currentColor" }}
          ></path>
        </svg>

        <span style={{ color: location.pathname === "/riwayat" ? "white" : "currentColor" }}>History</span>
      </button>
