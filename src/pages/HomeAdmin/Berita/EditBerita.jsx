          ...
          <div key={article.id} className="bg-white shadow-lg rounded-lg p-6 mb-6 hover:shadow-xl transition-shadow duration-300">
            <div className="flex justify-between items-center mb-4">
              ...
              <div className="flex space-x-2">
                <Link to={`/edit-berita/${article.id}`} className="text-blue-500 hover:text-blue-600 transition-colors duration-300">
                  Edit
                </Link>
            ...
            <div className="text-sm text-gray-500">Tanggal Pembuatan: {new Date(article.createdAt).toLocaleDateString()}</div>
          </div>
        ))
      ) : (
